...
@section('content')
    <div class="container" style="width: 500px; margin-top: 80px; border: 2px solid; border-radius: 25px; padding: 30px;">
        <!-- Pills navs -->
          ...
          <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
            <form>
              ...
              <div class="d-flex justify-content-center">
                <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary w-50">Sign in</button>
              </div>
